...
namespace ManageCategoriesApp
{
    ...
    public class ManageCategories
    {
        ...
        SqlCommand command;
        string ConnectionString = "Server=nam\\sqlexpress; uid=sa;pwd=sa; database=MyStore; TrustServerCertificate=True";
        ...
        public void InsertCategory(Category category)
        {
            ...
            catch (Exception ex) { MessageBox.Show(ex.Message, "insert error"); }
